...
Client.prototype.createChannel = function (transport, opts) {
  ...
  if (typeof transport == 'function') {
    ...
    if (objectMode) {
      ...
      callbackFactory = function (req, cb) {
  ...
  if (typeof transport == 'function') {
    ...
    if (objectMode) {
      ...
      callbackFactory = function (fn) {
        transport(function (readable, writable) {
...
StatelessClientChannel.prototype._send = function (id, reqBuf) {
  ...
  function emit(retry) {
    ...
    self._callbackFactory.call(self, req, function (err, res) {
      if (err) {
        cb(err);
        return;
      }
      ...
      try {
        var parts = readHead(HANDSHAKE_RESPONSE_TYPE, res);
        var hres = parts.head;
        if (hres.serverHash) {
...
function StatelessServerChannel(server, callbackFactory, opts) {
  ...
  var self = this;
  callbackFactory.call(this, function (buf, cb) {
    if (self.destroyed) {
