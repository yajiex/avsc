...
Service.prototype.createClient = function (opts) {
  ...
  // We delay processing such that we can attach handlers to the client before
  // any channels get created.
...
Client.prototype.createChannel = function (transport, opts) {
  ...
  debug('added client channel');
  var self = this;
  process.nextTick(function () { self.emit('channel', channel); });
  return channel;
};
